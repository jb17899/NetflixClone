...
return (
    ...
    <div
        className="relative"
        style={{
            backgroundImage: "linear-gradient(rgba(0, 0, 0, 0.7), rgba(31,41,55,0.1)), url('/hero.png')",
    ...
    >
        ...
        <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2 text-white'>
